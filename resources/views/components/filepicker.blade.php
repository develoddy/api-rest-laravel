...
<div class="relative px-2 py-3 border-2 border-dashed border-gray-300 dark:text-dark-300 dark:border-dark-700
    ...
    <x-icon name="document-text" class="h-6 w-6 absolute z-20 left-4 text-gray-300" />
    ...
    <x-icon name="x-circle" class="absolute right-3 h-8 w-8 text-gray-600 hover:text-gray-800 clear cursor-pointer hidden" type="solid" />
