        ...
        <div class="col col-md-8 col-lg-6 col-sm-10 col-xl-5 p-0">
            <div class="card mb-3 border-0">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex">
                        <div class="p-2">
                            {{-- <a href="{{ route('comments', 0) }}" class="text-secondary">Ver los 23.252 comentarios</a> --}}
                            <a onclick="showModal('form-mode-simple')" class="text-secondary">Ver los 23.252 comentarios</a>
                            <x-modal
                                size="xl"
