    ...
    <div id="app">
        <div class="container-fluid">
            <div class="row flex-nowrap">
                ...
                <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 border-end">
                    <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-dark min-vh-100">
                        <a href="/" class="d-flex align-items-center pb-3 mb-md-0 me-md-auto text-dark text-decoration-none">
                            ...
                            <span class="fs-2 d-none d-sm-inline fw-bolder">Space</span>
                        </a>
                        <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                            <li class="nav-item">
                                <a  href="{{ route('home') }}" class="nav-link align-middle px-0 text-dark">
                                    ...
                                    <span class="ms-1 d-none d-sm-inline fs-5 fw-bolder">Home</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('profile') }}" class="nav-link px-0 align-middle text-dark fs-5">
                ...
                {{-- El contenido se agregue dinamicamente --}}
                <div class="col py-3">
                    <main class="py-4">
                        @yield('content')
                    </main>
